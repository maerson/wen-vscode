...
export function activate_indent_rainbow(context: vscode.ExtensionContext) {
  ...
  const error_color =
    vscode.workspace.getConfiguration("wen_indentRainbow")["errorColor"] ||
    "rgba(128,32,32,0.3)";
  ...
  const tabmix_color =
    vscode.workspace.getConfiguration("wen_indentRainbow")["tabmixColor"] || "";
  ...
  const ignoreLinePatterns =
    vscode.workspace.getConfiguration("wen_indentRainbow")[
      "ignoreLinePatterns"
    ] || [];
  ...
  const indicatorStyle =
    vscode.workspace.getConfiguration("wen_indentRainbow")["indicatorStyle"] ||
    "classic";
  ...
  const colors = vscode.workspace.getConfiguration("wen_indentRainbow")[
    "colors"
  ] || [
  ...
  function triggerUpdateDecorations() {
    ...
    var updateDelay =
      vscode.workspace.getConfiguration("wen_indentRainbow")["updateDelay"] ||
      100;
